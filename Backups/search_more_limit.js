...
console.log(FieldMany2One);
/**
 * Patches the relational_fields to display search more always
 */
patch(FieldMany2One.prototype, "pinska_product_configurator_FieldMany2One", {
    _search: async function (searchValue = "") {
        ...
        console.log("Successful patch on search_more");

        // Add "Search mores..." option if results count is higher than the limit
        if (1 < values.length) {
